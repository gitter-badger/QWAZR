...
@Path("/store") public class StoreMasterDataService implements StoreDataServiceInterface {
    ...
    @Override public Response getFile(String schemaName, String path, Integer msTimeout) {
	try {
    ...
    @Override public StoreFileResult getDirectory(String schemaName, String path, Integer msTimeout) {
	try {
	    return getDataClient(StoreSchemaManager.INSTANCE.getSchema(schemaName).nodes, msTimeout)
    ...
    @Override public Response headFile(String schemaName, String path, Integer msTimeout) {
	try {
	    return getDataClient(StoreSchemaManager.INSTANCE.getSchema(schemaName).nodes, msTimeout)
    ...
    @Override final public StoreFileResult getDirectory(String schemaName, Integer msTimeout) {
	return getDirectory(schemaName, StringUtils.EMPTY, msTimeout);
    }

    @Override final public Response getFile(String schemaName, Integer msTimeout) {
	return getFile(schemaName, StringUtils.EMPTY, msTimeout);
    }

    @Override final public Response headFile(String schemaName, Integer msTimeout) {
	return headFile(schemaName, StringUtils.EMPTY, msTimeout);
    }

    @Override public Response putFile(String schemaName, String path, InputStream inputStream, Long lastModified,
    ...
    @Override public Response deleteFile(String schemaName, String path, Integer msTimeout) {
	try {
	    return getDataClient(StoreSchemaManager.INSTANCE.getSchema(schemaName).nodes, msTimeout)
    ...
    @Override public Set<String> getSchemas(Integer msTimeout) {
	try {
    ...
    @Override public Response createSchema(String schemaName, Integer msTimeout) {
	return Response.status(Status.NOT_IMPLEMENTED).build();
    }

    @Override public Response deleteSchema(String schemaName, Integer msTimeout) {
	return Response.status(Status.NOT_IMPLEMENTED).build();
    }
