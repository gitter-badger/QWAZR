...
@FixMethodOrder(MethodSorters.NAME_ASCENDING) public class CassandraTest {
	...
	return (CassandraConnector) ConnectorsTestContext.getConnectorManager().get("cassandra");
    }
    ...
    @Test public void test_02_create() throws IOException {
	try {
    ...
    @Test public void test_10_transaction() throws Exception {
    ...
    @Test public void test_98_drop() throws IOException {
	try {
	    CassandraConnector cassandra = getCassandra();
