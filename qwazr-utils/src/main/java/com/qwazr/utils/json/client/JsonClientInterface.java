...
public interface JsonClientInterface {
	 ...
	 * @param bodyObject
	 *            an optional object for the body.
	 * @param msTimeOut
	 ...
	 */
	public <T> T execute(Request request, Object bodyObject, Integer msTimeOut,
			Class<T> jsonResultClass, int... expectedCodes) throws IOException;
	 ...
	 */
	public <T> T execute(Request request, Object bodyObject, Integer msTimeOut,
			TypeReference<T> typeRef, int... expectedCodes) throws IOException;
