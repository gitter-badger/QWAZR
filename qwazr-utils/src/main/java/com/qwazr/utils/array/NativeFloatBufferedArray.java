...
public class NativeFloatBufferedArray implements FloatBufferedArrayInterface {
	...
	final private native void add(final long ref, final float[] buffer, final int length);
	...
	public native void populateFinalArray(final long ref, final float[] finalArray);
